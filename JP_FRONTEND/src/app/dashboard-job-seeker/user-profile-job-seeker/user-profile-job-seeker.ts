...
@Component({
  selector: 'app-user-profile-job-seeker',
  standalone: false,
  templateUrl: './user-profile-job-seeker.html',
  styleUrl: './user-profile-job-seeker.css'
})
export class UserProfileJobSeeker implements OnInit {
  profile: any = {};
